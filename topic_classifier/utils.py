...
RELATION_PROMPT = (
    ...
    "Вердикт:\n"
    "Вердикт может содержать только '1' или '0'. 1 если относится к dnd, "
...
CLASS_PROMPT = (
    ...
    "варвар, воин, друид, жрец, волшебник, изобретатель, колдун, монах, паладин, плут, "
    "следопыт, чародей,"
    ...
    "то отнеси это к bestiary. \n"
    "Если в тексте упоминаются магические предметы, например, зелье лечения, "
    "магические кольца или плащи, "
    ...
    "Если в тексте упоминается инвентарь, например, артефакты, безделушки, броня,"
    " оружие, инструменты, или"
